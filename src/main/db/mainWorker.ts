...
import { WrappedWorkerRequest, WrappedWorkerLogEntry, WrappedWorkerResponse } from './main'

if (!parentPort) throw new Error('Must run as a worker thread')

const port = parentPort

function respond(seq: number, error: Error | unknown | undefined, response?: unknown): void {
